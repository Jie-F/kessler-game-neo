...
def circle_line_collision_continuous(
    ...
    ---------------------
      ...
      * At any time t in [-delta_time, 0], the bullet is a segment from line_A + t*line_vel to line_B + t*line_vel
      ...
      * This yields an equation:
            (C + Vc * t) - (S + Vs * t + u*(E-S)) has Euclidean norm <= radius,
        where:
    ...
    # Edges are: lower, left, right, upper
    edges = [
